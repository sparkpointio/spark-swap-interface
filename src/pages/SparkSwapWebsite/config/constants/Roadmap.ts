...
export const Roadmaps: RoadmapConfig = {
  2022: {
    Q1: {
      ...
      March: [{ value: 'SFUEL Quarterly Community Airdrop' }, { value: 'New Trading Pairs in SparkSwap' }],
    },
    Q2: {
      June: [
        {
    ...
    Q3: {
      July: [
        {
          value: 'SparkPool: Revamp/Refresh',
        },
      ],
      August: [
        {
          value: 'SparkSwap: Launch of SparkSwap VIP Club',
        },
      ],
      September: [
        {
